        ...
        <ScrollView contentContainerStyle={styles.plansList}>
          <View style={[styles.planCard, { backgroundColor: colors.card, borderColor: colors.border, borderWidth: 1 }]}>
            ...
            <View style={styles.planFeatures}>
              ...
              <Text style={[styles.planFeature, { color: colors.text }]}><Ionicons name="checkmark-circle" size={16} color={colors.primary} /> Ativa automaticamente o Premium</Text>
              <Text style={[styles.planFeature, { color: colors.text }]}><Ionicons name="checkmark-circle" size={16} color={colors.primary} /> Acesso total ao app</Text>
              <Text style={[styles.planFeature, { color: colors.text }]}><Ionicons name="checkmark-circle" size={16} color={colors.primary} /> Chat e busca liberados</Text>
            </View>
